...
1. How would you describe acessibility on the web to someone new to programming?
    Acessibility allows anyone to access a webpage easily, even with disabilities.
2. Talk about 3 different things you can do to ensure your website is accessible. 
    Image tags assist visual impaired; Properly configured break points allows individuals to view a webpage on a variety of device sizes & types; Proper coloring assists those with visual impairments.
3. How would you explain the concept of a variable to someone new to programming?
    Variables are mutable or immutable inputs & expressions to store value.
4. What is the purpose of using functions in code?
    Functions allow dry, clean code by reducing repitition for commonly used tasks.
